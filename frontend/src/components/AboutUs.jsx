...
const AboutUs = () => {
    return (
        ...
        <div className="relative isolate px-6 pt-14 lg:px-40 aspect-square bg-[url('./assets/c1.png')] bg-no-repeat bg-cover group h-[400px] w-full">
            <blockquote class="text-4xl tracking-wider font-semibold font-playfair text-start text-slate-900 mb-5">
                Know About
            ...
            <div className='w-[50%] text-justify'>
                <p className='first-line:uppercase first-line:tracking-widest first-letter:text-7xl first-letter:font-bold first-letter:text-slate-900 first-letter:mr-3 first-letter:float-left font-publicSans tracking-wide'>
                    ...
                    games and interactive experiences to make space science accessible and enjoyable. <Link className='hover:bg-slate-900 rounded-full px-2 py-1 text-blue-900 font-semibold tracking-wider text-md'>Read More</Link>
                </p>
            </div>
        </div>
    )
