            ...
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <div className='flex items-center mb-2'>
                        ...
                        <span className='text-md font-publicSans tracking-wider font-medium text-gray-900'>Mangal Murti Apartment <br /> Tilker nagar, Hadapsar <br /> pune, Maharastra 411002</span>
                    </div>
                    <div className='flex items-center mb-2'>
                        <MdMarkEmailRead className='mr-3 text-xl' />
                        <span className='text-md font-publicSans tracking-wider font-medium text-gray-900'>
                            aryaswaroop027@gmail.com <br /> aryaswaroop9507@gmail.com
                        </span>
                    </div>
                    <div className='flex items-center mb-2'>
                        <IoCallSharp className='mr-3 text-xl' />
                        <span className='text-md font-publicSans tracking-wider font-medium text-gray-900'>+91 8340168072</span>
                    </div>
                </div>
